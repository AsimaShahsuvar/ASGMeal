  ...
  >
    ...
    >
      <li>
        <a
          href="#"
          @mouseover="hovSubmenu0()"
        >Floor</a>
        <ul
          class="submenu submenu0"
          @mouseleave="mouseoutMenu0()"
        >
          <li>
            <a
              href="#"
...
<!--      const closes = document.querySelector('.submenuGate2')-->
<!--      closes.style.display = 'none'-->
<!--      const close = document.querySelector('.submenu2')-->
...
<!--        // menu.style.top = (e.clientY - menu.offsetHeight) + "px";-->
<!--      }-->
<!--      console.log("changepos hover")-->
<!--    },-->
<!--    hovSubmenu0() {-->

<!--      const menu = document.querySelector('.submenu0')-->
<!--      const close = document.querySelector('.submenu1')-->
<!--      close.style.display = 'none'-->
<!--      const e = event-->
<!--      // console.log(e)-->
<!--      // e.preventDefault();-->
...
<!--    },-->
<!--    // mouseoutMenuGate() {-->
<!--    //   const menu = document.querySelector('.submenuGate2')-->
<!--    //   menu.style.display = 'none'-->
<!--    // },-->
...
<!--      const {data: positionData} = await positionsService.getList(this.building, floor, 101, 6)-->
<!--      this.allPosition = positionData-->

<!--      console.log("floor ho hover")-->
<!--    },-->
<!--    sleep(ms) {-->
...
<!--    async getGate() {-->
<!--      const e = event-->
<!--      const {data: positionData} = await positionsService.getList(this.building, 0, 101, 10)-->
<!--      this.allPosition = positionData-->

<!--      await this.sleep(10)-->
<!--      console.log(4444)-->
<!--      const menu = document.querySelector('.submenuGate2')-->
<!--      console.log('pooooo', menu.offsetHeight)-->
<!--      const submenu1 = document.querySelector('.submenu0')-->
<!--      const close = document.querySelector('.submenu1')-->
<!--      close.style.display = 'none'-->
<!--      // Show the context menu-->
<!--      menu.style.display = 'block'-->
...
<!--        menu.style.left = (e.clientX - menu.offsetWidth) + 'px'-->
<!--      }-->
<!--      // set position Y of the menu - yuxaridadi-->
<!--      if ((window.innerHeight) / 2 > e.clientY + 10) {-->
<!--        // menu.style.top = -100 + "px";-->
<!--        console.log("s", e.clientY, window.innerHeight, menu.offsetHeight)-->
<!--        let pos = -(e.clientY - (window.innerHeight - menu.offsetHeight) / 2)-->
...
<!--      } else {-->
<!--        console.log("ww", e.clientY, window.innerHeight, menu.offsetHeight)-->

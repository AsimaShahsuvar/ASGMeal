...
const ENDPOINT = '/palette/changeposition'
export default {
    ...
    changePalette(positionId, paletteId, statusCode) {
        return api.post(`${ENDPOINT}/?positionId=${positionId}&paletteId=${paletteId}&statusCode=${statusCode}`)
    },
